...
def home(request):
    ...
    Margin=int(round(margin,0))
    Profit=int(round(profit,0))
    Profitfrom_th=int(round(profit*1000,0))
    #удаляе=м списки
    del jita_buy
    del jita_sell
    ...
    return render(request, 'main/home.html', {"Margin":Margin, "Profit":Profit, "Profitfr_th":Profitfrom_th})
